...
/**
 * Controlador REST para cálculo de distancias usando Google Maps Distance Matrix API
 * Endpoints:
 *  - GET /api/distancia?origen=Buenos%20Aires&destino=La%20Plata
 *  - GET /api/distancia?origen=-34.603722,-58.381592&destino=-34.615851,-58.433238
 */
@RestController
...
public class GeoController {
     ...
     * 
     * @param origen ubicación de origen (ej: "Buenos Aires" o coordenadas "-34.603722,-58.381592")
     * @param destino ubicación de destino (ej: "La Plata" o coordenadas "-34.615851,-58.433238")
