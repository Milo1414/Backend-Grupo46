...
import tpi_grupo46.logistica.dto.CrearTramoDTO;
import tpi_grupo46.logistica.dto.CrearRutaDTO;
 ...
 * Proporciona endpoints para crear y consultar rutas.
 */
@RestController
...
public class RutaController {
   ...
   *
   * @param crearRutaDTO Datos de la ruta a crear con sus tramos
  ...
  public ResponseEntity<RutaDTO> crearRuta(@RequestBody CrearRutaDTO crearRutaDTO) {
    ...
    var ruta = solicitudService.crearRuta(crearRutaDTO.solicitudId(), tramos);
